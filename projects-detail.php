...
<div class='detail'> 
    ...
    <p style='text-align: center;'><span class='firstcharacter'></span>" . stripslashes($row['team']) . "</p>

    <p style='text-align: center;'><em>Keyword :" . stripslashes($row['keyword']) . "</em></p>
    
    <h4 style='text-align: center;'><strong>Abstract</strong></h4>
    <p>" . stripslashes($row['abstract']) . "</p>
    
    <h4 style='text-align: center;'><strong>Introduction</strong></h4>
    <p>" . stripslashes($row['background']) . "</p>
    
    <h4 style='text-align: center;'><strong>Methods</strong></h4>
    <p>" . stripslashes($row['methods']) . "</p>
    
    <h4 style='text-align: center;'><strong>Results</strong></h4>
    <p>" . stripslashes($row['results']) . "</p>
    
    <h4 style='text-align: center;'><strong>Discussion</strong></h4>
    <p>" . stripslashes($row['discussion']) . "</p>
    
    <h4 style='text-align: center;'><strong>Conclusions</strong></h4>
    <p>" . stripslashes($row['conclusions']) . "</p>
    
    <div class='row'>
        <div class='col-6'>
            <h4><strong>References</strong></h4>
            <p>" . stripslashes($row['references']) . "</p>
        </div>
        <div class='col-6'>
            <p>" . stripslashes($row['references2']) . "</p> 
        </div>
    </div>
</div>";
          ...
          ?>
                  <button onclick='history.back()'>Go Back</button justify-content-center>
