...
WHERE team like '%" . $text . "%' 
or title like '%" . $text . "%' 
or background like '%" . $text . "%' 
or methods like '%" . $text . "%' 
or results like '%" . $text . "%' 
or discussion like '%" . $text . "%' 
or conclusions like '%" . $text . "%' 
           ...
           if ($submit=='Search') {
              ...
              //echo $sql;
               ...
               echo "<h1>Maybe what you're looking for... : </h1><br>";
				...
				{
				    	echo "<h2><li><a href='projects-detail.php?x=" .$row->id_project ."'>" . $row->title . "</li></h2>";
		  ...
		  else
     		{
				...
				<p><input type="text" name="text-to-search" id="text-to-search" size="20"></p> <br>
