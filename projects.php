...
.projects-wrap .information .projects-info h3 {
    text-align: center;
}

.projects-wrap .information .projects-info p {
    text-align: center;
}
 ...
 echo '<li><a href="logout.php"> <i style="font-size:24px" class="fa fa-sign-out"></i> </a></li>'; 
  ...
  <main id="main">
    ...
    <section id="projects" class="projects">
      <h4 class="animate__animated animate__fadeInUp"> Research Projects</h4> <br>
      ...
      <div class = "col">
    <a href="delete.php"class="btn btn-sm btn-success">Delete</a>
       </div>
       </div>
       </div>'; }
        ?>
...
<img src='./upload/$row[gambarName]' >
              ...
              <div class = 'information'>
                <div class='projects-info'>     
                  ...
                  <br>
                  <br>
                  <p style='text-align: center;'>$row[keyword]</p> 
                </div>
                </div>
            </a> 
          </div>  
            ...
            <div class="col-6">
              <div class="footer-info">
                ...
                <div class="social-links mt-3">
                  ...
                  <a href="https://www.facebook.com/USMOfficial1969" class="facebook"><i
